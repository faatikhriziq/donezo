...
class AuthBloc extends Bloc<AuthEvent, AuthState> {
  ...
  AuthBloc({required this.signInParams, required this.signInWithEmailPasswordUseCase, required this.signUpUseCase, required this.signUpParams}) : super(AuthInitial()) {
